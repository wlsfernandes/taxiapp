...
import com.asthon.taxi.app.exception.VehicleServiceException;
import com.asthon.taxi.app.model.Vehicle;
import com.asthon.taxi.app.service.VehicleService;
...
public class VehicleController {
	...
	public List<Vehicle> getAllVehicles() {
		try {
			...
			if (null == listVehicles)
				throw new ResponseStatusException(HttpStatus.NOT_FOUND, " Vehicles list not found");
			return listVehicles;
	...
	public Vehicle getOne(@PathVariable Long id) {
		try {
			...
			if (null == vehicle)
				throw new ResponseStatusException(HttpStatus.NOT_FOUND,"Vehicle not found id " + id);
			return vehicle;
		} catch (VehicleServiceException e) {
